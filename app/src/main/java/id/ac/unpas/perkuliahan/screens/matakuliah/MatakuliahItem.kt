...
@Composable
fun MatakuliahItem(item: Matakuliah, navController:
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Row(modifier = Modifier
            ...
            Column(modifier = Modifier.weight(3f)) {
                ...
                Text(text = item.sks.toString(), fontSize =
                16.sp, fontWeight = FontWeight.Bold)
            }

            Column(modifier = Modifier.weight(3f)) {
                Text(text = "Praktikum", fontSize = 14.sp)
                Text(text = item.praktikum.toString(), fontSize =
                16.sp, fontWeight = FontWeight.Bold)
            }

            Column(modifier = Modifier.weight(3f)) {
                Text(text = "Deskripsi", fontSize = 14.sp)
                Text(text = item.deskripsi, fontSize =
                16.sp, fontWeight = FontWeight.Bold)
            }
