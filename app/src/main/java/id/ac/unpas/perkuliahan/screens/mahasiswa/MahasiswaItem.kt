...
@Composable
fun MahasiswaItem(item: Mahasiswa, navController:
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Row(modifier = Modifier
            ...
            Column(modifier = Modifier.weight(3f)) {
                ...
                Text(text = item.npm, fontSize = 16.sp,
            ...
            Column(modifier = Modifier.weight(3f)) {
                ...
                Text(text = item.tanggal_lahir, fontSize =
                16.sp, fontWeight = FontWeight.Bold)
            }

            Column(modifier = Modifier.weight(3f)) {
                Text(text = "Jenis Kelamin", fontSize = 14.sp)
                Text(text = item.jenis_kelamin, fontSize =
                16.sp, fontWeight = FontWeight.Bold)
            }
