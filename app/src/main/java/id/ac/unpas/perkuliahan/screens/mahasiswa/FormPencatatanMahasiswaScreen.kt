...
@Composable
fun FormPencatatanMahasiswaScreen (navController: NavHostController, id: String? = null, modifier: Modifier = Modifier) {
        ...
        Row(
            ...
            Button(modifier = Modifier.weight(5f),
                onClick = {
                    if (id == null) {
                        scope.launch {
                            viewModel.insert(npm.value.text, nama.value.text, tanggal_lahir.value.text
